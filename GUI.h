...
struct GUI {
    ...
    static std::vector<sf::Text> getMainGraphics(std::vector<sf::Text> buttons, sf::RenderWindow & window, std::vector<File> & files, int const& skip, sf::RectangleShape & rect);
};
