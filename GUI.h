...
struct GUI {
    ...
    static void getMainGraphics(bool & isListNew, std::vector<sf::Sprite> & vec, std::vector<sf::Text> & buttons, sf::RenderWindow & window, std::vector<File> & files, int const& skip, sf::RectangleShape & rect, sf::RectangleShape const& menuBase);
